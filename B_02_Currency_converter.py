...
class Converter:
    def __init__(self):
        ...
        button_details_list = [
            ...
            ["NZD to AUD", "#009900", lambda: self.check_amount("NZD", "AUD"), 0, 1],
            ["USD to AUD", "#800000", lambda: self.check_amount("USD", "AUD"), 1, 0],
            ["NZD to USD", "#336699", lambda: self.check_amount("NZD", "USD"), 1, 1],
            ["Help / Info", "#CC6600", self.to_help, 2, 0],
            ["History / Export", "#004C99", self.to_history, 2, 1],
        ]
        ...
        self.to_help_button = self.button_ref_list[4]
        self.to_history_button = self.button_ref_list[5]
